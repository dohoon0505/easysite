...
function AppBar({ title, onBack, scrolled, dark, onToggleTheme }) {
  return (
    <div className={"appbar " + (scrolled ? "shadow" : "")}>
      ...
      <div className="pagetitle">{title || "별케이크"}</div>
      <div className="grow" />
      <button
...
async function shareSite() {
  const data = {
    title: "별케이크",
    text: "레터링케이크 전문점 별케이크 — 특별한 날을 더 특별하게.",
...
function HomeScreen({ go, openStyle, openDesigner }) {
  return (
    <div>
      <section className="hero" aria-label="별케이크">
        <div className="hero-img">
          <img src="img/hero.jpg" alt="별케이크 매장" />
        </div>
      </section>

      <section className="intro">
        <div className="intro-meta">대구광역시 | 수성구</div>
        <h2 className="intro-name">별케이크</h2>
        ...
        <div className="intro-map" aria-label="매장 위치 지도">
          <img src="img/map.png" alt="별케이크 매장 위치" className="intro-map-img" />
