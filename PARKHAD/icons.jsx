...
const I = {
  ...
  Style:   ({ size = 22 }) => (
    <svg width={size * 0.93} height={size * 0.93} viewBox="0 0 56 56" fill="currentColor" stroke="none" aria-hidden="true">
  ...
  Faq:     ({ size = 22 }) => (
    <svg width={size * 0.85} height={size * 0.85} viewBox="0 0 512 512" fill="currentColor" stroke="none" aria-hidden="true">
